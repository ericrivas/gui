...
"}")
        ...
        self.label_title.setGeometry(QtCore.QRect(0, 70, 661, 100))
...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(_translate("SplashScreen", "<html><head/><body><p>UD ASAE</p></body></html>"))
        self.label_description.setText(_translate("SplashScreen", "<html><head/><body><p><span style=\" font-weight:600;\">Payload Operator GUI</span></p></body></html>"))
